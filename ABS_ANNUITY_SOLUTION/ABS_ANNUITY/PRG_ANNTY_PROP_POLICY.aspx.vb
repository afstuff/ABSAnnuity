...
Partial Class PRG_ANNTY_PROP_POLICY
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        STRMENU_TITLE = "+++ Annuity Proposal Menu +++ "
        BufferStr = ""
    ...
    Private Sub DoProc_Menu(ByVal pvMenu As String)
        Select Case pvMenu.ToUpper
            ...
            Case "AN_QUOTE"
                ...
                AddMenuItem("Proposal Entry", "New Proposal", "PRG_ANNTY_POLY_PERSNAL.aspx?optid=NEW")
                AddMenuItem("", "Change Proposal", "PRG_ANNTY_POLY_PERSNAL.aspx?optid=CHG")
                'AddMenuItem("", "Delete Proposal", "PRG_LI_INDV_POLY_PERSNAL.aspx?optid=DEL")
                AddMenuItem("", "Delete Proposal", "")
                'AddMenuItem("", "UNDER_LINE", "") 'blank link
                AddMenuItem("", "", "") 'blank link
                AddMenuItem("", "Convert Proposal to Policy", "PRG_ANNTY_POLY_CONVERT.aspx")
                'AddMenuItem("", "", "") 'blank link
