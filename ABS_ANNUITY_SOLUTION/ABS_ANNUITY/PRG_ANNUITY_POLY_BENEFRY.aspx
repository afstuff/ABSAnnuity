<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PRG_ANNUITY_POLY_BENEFRY.aspx.vb" Inherits="PRG_ANNUITY_POLY_BENEFRY" %>
...
<head id="Head1" runat="server">
	<title>Beneficiary Module</title>
								...
								<td align="center" colspan="4" valign="top">
												<asp:GridView ID="GridView1" CellPadding="2" runat="server" CssClass="grd_ctrl"
													...
													<Columns>
														...
														<asp:BoundField ReadOnly="true" DataField="TBIL_ANN_BENF_REC_ID" HeaderText="Ref.No" HeaderStyle-HorizontalAlign="Left" ConvertEmptyStringToNull="true" />
														<asp:BoundField ReadOnly="true" DataField="TBIL_ANN_BENF_NAME" HeaderText="Beneficiary Name" HeaderStyle-HorizontalAlign="Left" ConvertEmptyStringToNull="true" />
														<asp:BoundField ReadOnly="true" DataField="TBIL_ANN_BENF_BDATE" HeaderText="Date of Birth" HeaderStyle-HorizontalAlign="Left" ConvertEmptyStringToNull="true" DataFormatString="{0:dd MMM yyyy}" />
														<asp:BoundField ReadOnly="true" DataField="TBIL_ANN_BENF_AGE" HeaderText="Age" HeaderStyle-HorizontalAlign="Left" ConvertEmptyStringToNull="true" />
														<asp:BoundField ReadOnly="true" DataField="TBIL_ANN_BENF_PCENT" HeaderText="PCent %" HeaderStyle-HorizontalAlign="Left" ConvertEmptyStringToNull="true" />
														<asp:BoundField ReadOnly="true" DataField="TBIL_ANN_BENF_GURDN_NM" HeaderText="Guardian Name" HeaderStyle-HorizontalAlign="Left" ConvertEmptyStringToNull="true" />
														<asp:BoundField ReadOnly="true" DataField="TBIL_ANN_BENF_COVER_ID" HeaderText="Cover ID" HeaderStyle-HorizontalAlign="Left" ConvertEmptyStringToNull="true" />
													</Columns>
