...
MyRtn_Ok:
    ...
    Protected Sub cboCustModule_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboCustModule.SelectedIndexChanged
    ...
    Protected Sub cboCustClass_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboCustClass.SelectedIndexChanged
