...
Imports System.Data
Partial Class PRG_ANNUITY_POLY_BENEFRY
    ...
    Private Sub Proc_DataBind()
        ...
        strSQL = strSQL & " WHERE TBIL_ANN_BENF_FILE_NO = '" & RTrim(strF_ID) & "'"
        strSQL = strSQL & " AND TBIL_ANN_BENF_PROP_NO = '" & RTrim(strQ_ID) & "'"
        strSQL = strSQL & " ORDER BY TBIL_ANN_BENF_COVER_ID, TBIL_ANN_BENF_SNO"
    ...
    Private Sub Proc_DoDelete()
        ...
        strSQL = strSQL & " WHERE TBIL_ANN_BENF_FILE_NO = '" & RTrim(strREC_ID) & "'"
        strSQL = strSQL & " AND TBIL_ANN_BENF_PROP_NO = '" & RTrim(Me.txtQuote_Num.Text) & "'"
    ...
    Protected Sub Proc_DoDelete_Record()
        ...
        strSQL = "DELETE FROM " & strTable
        strSQL = strSQL & " WHERE TBIL_ANN_BENF_FILE_NO = '" & RTrim(strREC_ID) & "'"
        strSQL = strSQL & " AND TBIL_ANN_BENF_PROP_NO = '" & RTrim(txtQuote_Num.Text) & "'"
        strSQL = strSQL & " AND TBIL_ANN_BENF_REC_ID = " & Val(RTrim(Me.txtRecNo.Text)) & ""
...
Proc_Skip_ANB:
        ...
        strSQL = strSQL & " WHERE TBIL_ANN_BENF_FILE_NO = '" & RTrim(txtFileNum.Text) & "'"
        'strSQL = strSQL & " AND TBIL_ANN_BENF_PROP_NO = '" & RTrim(txtQuote_Num.Text) & "'"
        'If Val(LTrim(RTrim(Me.txtRecNo.Text))) <> 0 Then
        strSQL = strSQL & " AND TBIL_ANN_BENF_REC_ID = '" & Val(RTrim(txtRecNo.Text)) & "'"
        'End If
        ...
        Try
            ...
            If obj_DT.Rows.Count = 0 Then
                ...
                drNewRow("TBIL_ANN_BENF_MDLE") = RTrim("I")

                drNewRow("TBIL_ANN_BENF_FILE_NO") = RTrim(Me.txtFileNum.Text)
                drNewRow("TBIL_ANN_BENF_PROP_NO") = RTrim(Me.txtQuote_Num.Text)
                drNewRow("TBIL_ANN_BENF_POLY_NO") = RTrim(Me.txtPolNum.Text) 'uncommented by james

                drNewRow("TBIL_ANN_BENF_COVER_ID") = Val(Me.txtBenef_Cover_ID.Text)

                drNewRow("TBIL_ANN_BENF_SNO") = Val(Me.txtBenef_SN.Text)
                drNewRow("TBIL_ANN_BENF_TYPE") = RTrim(Me.txtBenef_Type.Text)
                drNewRow("TBIL_ANN_BENF_CAT") = RTrim(Me.txtBenef_Category.Text)

                If Trim(Me.txtBenef_DOB.Text) <> "" Then
                    drNewRow("TBIL_ANN_BENF_BDATE") = dteDOB
                End If

                drNewRow("TBIL_ANN_BENF_AGE") = Val(Me.txtBenef_Age.Text)
                drNewRow("TBIL_ANN_BENF_RELATN_CD") = RTrim(Me.txtBenef_Relationship.Text)
                drNewRow("TBIL_ANN_BENF_NAME") = RTrim(Me.txtBenef_Name.Text)

                drNewRow("TBIL_ANN_BENF_PCENT") = Val(Me.txtBenef_Percentage.Text)
                drNewRow("TBIL_ANN_BENF_GURDN_NM") = RTrim(Me.txtBenef_GuardianName.Text)
                drNewRow("TBIL_ANN_BENF_ADRESS") = Trim(Me.txtBenef_Address.Text)

                drNewRow("TBIL_ANN_BENF_FLAG") = "A"
                drNewRow("TBIL_ANN_BENF_OPERID") = CType(myUserIDX, String)
                drNewRow("TBIL_ANN_BENF_KEYDTE") = Now
            ...
            Else
                ...
                With obj_DT
                    ...
                    .Rows(0)("TBIL_ANN_BENF_PROP_NO") = RTrim(Me.txtQuote_Num.Text)
                    .Rows(0)("TBIL_ANN_BENF_POLY_NO") = RTrim(Me.txtPolNum.Text) 'uncommented by james

                    .Rows(0)("TBIL_ANN_BENF_COVER_ID") = Val(Me.txtBenef_Cover_ID.Text)

                    .Rows(0)("TBIL_ANN_BENF_SNO") = Val(Me.txtBenef_SN.Text)
                    .Rows(0)("TBIL_ANN_BENF_TYPE") = RTrim(Me.txtBenef_Type.Text)
                    .Rows(0)("TBIL_ANN_BENF_CAT") = RTrim(Me.txtBenef_Category.Text)

                    If Trim(Me.txtBenef_DOB.Text) <> "" Then
                        .Rows(0)("TBIL_ANN_BENF_BDATE") = dteDOB
                    End If

                    .Rows(0)("TBIL_ANN_BENF_AGE") = Val(Me.txtBenef_Age.Text)
                    .Rows(0)("TBIL_ANN_BENF_RELATN_CD") = RTrim(Me.txtBenef_Relationship.Text)
                    .Rows(0)("TBIL_ANN_BENF_NAME") = RTrim(Me.txtBenef_Name.Text)

                    .Rows(0)("TBIL_ANN_BENF_PCENT") = Val(Me.txtBenef_Percentage.Text)
                    .Rows(0)("TBIL_ANN_BENF_GURDN_NM") = RTrim(Me.txtBenef_GuardianName.Text)
                    .Rows(0)("TBIL_ANN_BENF_ADRESS") = Trim(Me.txtBenef_Address.Text)

                    .Rows(0)("TBIL_ANN_BENF_FLAG") = "C"
                    '.Rows(0)("TBIL_ANN_BENF_OPERID") = CType(myUserIDX, String)
                    '.Rows(0)("TBIL_ANN_BENF_KEYDTE") = Now
                End With
    ...
    Private Function Proc_DoOpenRecord(ByVal FVstrGetType As String, ByVal FVstrRefNum As String, Optional ByVal FVstrRecNo As String = "", Optional ByVal strSearchByWhat As String = "FILE_NUM") As String
        ...
        If (objOLEDR.Read()) Then
            ...
            Me.txtPolNum.Text = RTrim(CType(objOLEDR("TBIL_ANN_BENF_POLY_NO") & vbNullString, String))
