...
Partial Class MENU_AN
    ...
    Protected Sub LNK_UND_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles LNK_UND.Click
        Response.Redirect("MENU_AN.aspx?menu=AN_UND")
    End Sub

    Protected Sub LNK_ENDORSE_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles LNK_ENDORSE.Click
        Response.Redirect("MENU_AN.aspx?menu=AN_ENDORSE")
    End Sub

    Protected Sub LNK_PROCESS_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles LNK_PROCESS.Click
        Response.Redirect("MENU_AN.aspx?menu=AN_PROCESS")
    End Sub

    Protected Sub LNK_CLP_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles LNK_CLP.Click
        Response.Redirect("MENU_AN.aspx?menu=AN_CLAIM")
    End Sub

    Protected Sub LNK_REINS_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles LNK_REINS.Click
